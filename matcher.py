...
def create_keplergl_map(df):
    ...
    from keplergl import KeplerGl
    m = KeplerGl(height=900, config=create_keplergl_config(df))
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        sys.exit(1)
    for jt9_ft8_file in sys.argv[1:]:
    ...
    cqdf = maindf[maindf['Message'].str.contains('CQ', na=False)] # Filter out RR73 messages if needed
    ...
    ft8_map = create_folium_map(maindf)
